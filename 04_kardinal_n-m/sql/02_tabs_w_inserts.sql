...
CREATE TABLE IF NOT EXISTS `mydb`.`servants_has_products` (
...
DESCRIBE mydb.servants_has_products;

INSERT INTO `mydb`.`servants_has_products` (`servants_id`, `products_id`) VALUES (1, 1);
INSERT INTO `mydb`.`servants_has_products` (`servants_id`, `products_id`) VALUES (1, 2);
INSERT INTO `mydb`.`servants_has_products` (`servants_id`, `products_id`) VALUES (2, 1);
INSERT INTO `mydb`.`servants_has_products` (`servants_id`, `products_id`) VALUES (2, 2);
INSERT INTO `mydb`.`servants_has_products` (`servants_id`, `products_id`) VALUES (2, 3);
INSERT INTO `mydb`.`servants_has_products` (`servants_id`, `products_id`) VALUES (2, 4);

SELECT * FROM mydb.servants_has_products;
